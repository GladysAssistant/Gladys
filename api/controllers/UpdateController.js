module.exports = {
  ...
  updateCategories: function(req, res, next) {
    gladys.update
      .getCategories(req.session.User)
      .then(result => res.json(result))
      .catch(next);
  },
