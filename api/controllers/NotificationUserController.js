...
module.exports = {
    ...
    index: function(req, res, next){
        gladys.notificationUser.get(req.session.User)
    ...
    create: function(req, res, next){
        ...
        gladys.notificationUser.create(req.body)
    ...
    update: function(req, res, next){
        ...
        gladys.notificationUser.update(req.body)
          .then(function(notificationUser){
    ...
    delete: function(req, res, next){
        gladys.notificationUser.delete({id: req.params.id})
          .then(function(){
