...
/**
 * @public
 * @name gladys.television.setChannel
 * @description Displays the channel on the TV. You can set the devicetype attribute OR the room attribute (if only one TV per room) OR the device attribute to determine which TV you want to use. If there is only one TV declared, you can skip params: it will be chosen by default.
 * @param {Object} params
