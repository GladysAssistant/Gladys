...
module.exports = {
  ...
  getByRooms: `
    ...
    dt.lastValueDatetime as lastChanged, dt.lastValue AS lastValue, room.id as roomId, room.name as roomName, room.house as roomHouse, dt.name as deviceTypeName, dt.idDeviceTypeOrder
    FROM device d
    JOIN devicetype dt ON d.id = dt.device
