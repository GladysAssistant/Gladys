...
module.exports = function serverError(data, options) {
  ...
  if (sails.config.errors[data.message]) {
    response = sails.config.errors[data.message]; 
  } else {
    response = sails.config.errors.DEFAULT; 
  }
  ...
  if (options.view) {
    ...
    return res.view('500', { data: data, layout: null }, function(err, html) {
