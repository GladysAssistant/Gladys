describe('Dashboard', () => {
  ...
  it('Should create new dashboard', () => {
    ...
    cy.contains('a', 'dashboard.newDashboardButton').should('have.class', 'btn-success').click();
    ...
    cy.contains('button', 'newDashboard.createDashboardButton').should('have.class', 'btn-primary').click();
  ...
  it('Should delete dashboard', () => {
    cy.contains('dashboard.editDashboardButton').should('have.class', 'btn-outline-primary').click();
    cy.contains('dashboard.editDashboardDeleteButton').should('have.class', 'btn-outline-danger').click();
    cy.contains('dashboard.editDashboardDeleteButton').should('have.class', 'btn-outline-danger').click();
