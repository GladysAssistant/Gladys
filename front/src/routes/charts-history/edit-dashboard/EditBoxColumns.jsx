...
const EditBoxColumns = ({ children, ...props }) => (
  <div class="pb-6">
    <h3>
      <Text id="charts-history.editChartsHistoryTitle" />
    </h3>
    {props.dashboardAlreadyExistError && (
      <div class="alert alert-danger">
        <Text id="charts-history.newChartsHistory.dashboardAlreadyExist" />
      </div>
    )}{' '}
    {props.dashboardValidationError && (
      <div class="alert alert-danger">
        <Text id="charts-history.newChartsHistory.validationError" />
      </div>
    )}
    {props.unknownError && (
      <div class="alert alert-danger">
      ...
      <div class="col-md-4">
        <div class="form-group">
          <label class="form-label">
            <Text id="charts-history.editChartsHistoryNameLabel" />
          </label>
          <Localizer>
            <input
              type="text"
              class="form-control"
              placeholder={<Text id="charts-history.editChartsHistoryNameLabel" />}
      ...
      <div class="col-md-8">
        <div class="form-group">
          ...
          {props.user.id !== props.homeDashboard.user_id && (
            <div>
              <small>
                <Text id="charts-history.editChartsHistoryVisibilityNotEditableNotCreator" />
              </small>
            </div>
          )}
          <Localizer>
    ...
    <div class="row mb-4">
      <div class="col-md-12">
        <Text id="charts-history.editChartsHistoryExplanation" />
      </div>
    </div>
    <div class="row mb-6">
      ...
      <div class="d-flex flex-row flex-wrap justify-content-center">
        {props.homeDashboard &&
          ...
          props.homeDashboard.boxes.map((column, x) => (
            <div
              class={cx('d-flex flex-column col-lg-12', style.removePadding, {
