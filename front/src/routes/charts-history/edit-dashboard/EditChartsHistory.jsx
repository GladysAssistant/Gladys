...
const EditChartsHistory = ({ children, ...props }) => (
  <div class="page">
    <div class="page-main">
                ...
                <div class="col-lg-3">
                  <div class="card">
                    <div class="card-header">
                      <h3 class="card-title">
                        <Text id="charts-history.editChartsHistoryMyDashboards" />
                      </h3>
                      <div class="page-options d-flex">
                        <Link
                          href={`/dashboard/charts-history/create/new?prev=${get(props, 'currentDashboard.selector')}`}
...
export default EditChartsHistory;
