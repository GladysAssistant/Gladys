...
class Zwavejs2mqttNodeOperationPage extends Component {
  ...
  componentWillMount() {
    ...
    this.props.session.dispatcher.addListener(WEBSOCKET_MESSAGE_TYPES.ZWAVEJS2MQTT.NODE_REMOVED, this.nodeRemovedListener);
  }

  componentWillUnmount() {
    this.props.session.dispatcher.removeListener(WEBSOCKET_MESSAGE_TYPES.ZWAVEJS2MQTT.NODE_ADDED, this.nodeAddedListener);
    this.props.session.dispatcher.removeListener(WEBSOCKET_MESSAGE_TYPES.ZWAVEJS2MQTT.NODE_READY, this.nodeReadyListener);
    this.props.session.dispatcher.addListener(WEBSOCKET_MESSAGE_TYPES.ZWAVEJS2MQTT.NODE_REMOVED, this.nodeRemovedListener);
  }
