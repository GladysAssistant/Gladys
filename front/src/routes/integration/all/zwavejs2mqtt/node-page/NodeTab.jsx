...
const NodeTab = ({ children, ...props }) => (
  <div class="card">
    <div class="card-header">
      <h3 class="card-title">
        <Text id="integration.zwavejs2mqtt.device.title" />
      </h3>
        ...
        <div class="input-icon ml-2">
          ...
          <Localizer>
            <input
              ...
              placeholder={<Text id="integration.zwavejs2mqtt.device.search" />}
        ...
        <div class="dimmer-content">
          {props.zwaveDevices && props.zwaveDevices.length === 0 && (
            <div class="alert alert-info">
              <Text id="integration.zwavejs2mqtt.device.noDevices" />
            </div>
          )}
