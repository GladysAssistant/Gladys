            ...
            <div class="dimmer-content">
              <div class="card-body">
                <div class="form-group">
                  <label>
                    <Text id="integration.zwavejs2mqtt.device.nameLabel" />
                  </label>
                  <Localizer>
                    <input
                      type="text"
                      ...
                      class="form-control"
                      placeholder={<Text id="integration.zwavejs2mqtt.device.nameLabel" />}
                    />
                  </Localizer>
                </div>
                <div class="form-group">
                  <label>
                    <Text id="integration.zwavejs2mqtt.device.roomLabel" />
                  </label>
                ...
                <div class="form-group">
                  <label>
                    <Text id="integration.zwavejs2mqtt.device.featuresLabel" />
                  </label>
                  <DeviceFeatures features={props.device.features} />
                  <p class="mt-4">
                    {mostRecentValueAt ? (
                      <Text
                        id="integration.zwavejs2mqtt.device.mostRecentValueAt"
                        fields={{
                      ...
                      <Text id="integration.zwavejs2mqtt.device.noValueReceived" />
                    )}
                  </p>
                </div>
                <div class="form-group">
                  <button onClick={this.saveDevice} class="btn btn-success mr-2">
                    <Text id="integration.zwavejs2mqtt.device.saveButton" />
                  </button>
                  <button onClick={this.deleteDevice} class="btn btn-danger">
                    <Text id="integration.zwavejs2mqtt.device.deleteButton" />
                  </button>
                  <Link href={`/dashboard/integration/device/zwavejs2mqtt/edit/${props.device.selector}`}>
                    <button class="btn btn-secondary float-right">
                      <Text id="integration.zwavejs2mqtt.device.editButton" />
                    </button>
                  </Link>
                </div>
              </div>
