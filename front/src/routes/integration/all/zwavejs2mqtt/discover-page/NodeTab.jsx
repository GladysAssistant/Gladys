    ...
    <div class="card">
      <div class="card-header">
        ...
        <div class="page-options d-flex">
          ...
          <a href={zwaveActionsEnabled ? '/dashboard/integration/device/zwavejs2mqtt/node-operation?action=add-secure' : '#'}>
            <button class="btn btn-outline-success ml-2" disabled={zwaveActionsDisabled}>
              <Text id="integration.zwave.discover.addNodeSecureButton" /> <i class="fe fe-plus" />
            </button>
          </a>
          <a href={zwaveActionsEnabled ? '/dashboard/integration/device/zwavejs2mqtt/node-operation?action=remove' : '#'}>
