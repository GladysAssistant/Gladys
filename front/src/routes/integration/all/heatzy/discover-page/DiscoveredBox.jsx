              ...
              <div class="card-body">
                {saveError && (
                  <div class="alert alert-danger">
                    <Text id="integration.heatzy.saveError" />
                  </div>
                )}
                <div class="form-group">
                  <label class="form-label" for={`name_${props.deviceIndex}`}>
                    <Text id="integration.heatzy.nameLabel" />
                  </label>
                  <Localizer>
                    <input
                      ...
                      class="form-control"
                      placeholder={<Text id="integration.heatzy.namePlaceholder" />}
                    />
                  </Localizer>
                </div>
                ...
                <div class="form-group">
                  <label class="form-label" for={`room_${props.deviceIndex}`}>
                    <Text id="integration.heatzy.roomLabel" />
                  </label>
                ...
                <div class="form-group">
                  <label class="form-label">
                    <Text id="integration.heatzy.featuresLabel" />
                  </label>
                  <div class="tags">
                    {props.device &&
                ...
                <div class="form-group">
                  {props.device.created_at && (
                    <button disabled="true" class="btn btn-primary mr-2">
                      <Text id="integration.heatzy.alreadyExistsButton" />
                    </button>
                  )}
                  {!props.device.created_at && (
                    <button onClick={this.saveDevice} class="btn btn-success mr-2">
                      <Text id="integration.heatzy.saveButton" />
                    </button>
                  )}
                </div>
              </div>
