...
class HeatzyDeviceForm extends Component {
  updateName = e => {
      ...
      <div>
        <div class="form-group">
          <label class="form-label" for="deviceName">
            <Text id="integration.heatzy.device.nameLabel" />
          </label>
          <Localizer>
            <input
              id="deviceName"
              ...
              class="form-control"
              placeholder={<Text id="integration.heatzy.device.nameLabel" />}
            />
          </Localizer>
        </div>
        ...
        <div class="form-group">
          <label class="form-label" for="room">
            <Text id="integration.heatzy.device.roomLabel" />
          </label>
        ...
        <div class="form-group">
          <label class="form-label">
            <Text id="integration.heatzy.device.featuresLabel" />
          </label>
          <div class="tags">
            {props.device &&
            ...
            {(!props.device.features || props.device.features.length === 0) && (
              <Text id="integration.heatzy.device.noFeatures" />
            )}
          </div>
        </div>
      </div>
...
export default HeatzyDeviceForm;
