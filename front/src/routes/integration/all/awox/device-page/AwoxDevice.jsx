...
class AwoxDevice extends Component {
          ...
          >
            ...
            <div class="dimmer-content">
              <div class="card-body">
                ...
                <div class="form-group">
                  <label>
                    <Text id="integration.awox.device.featuresLabel" />
                  </label>
                  {device.features && (
                    <div class="tags">
                  ...
                  {(!device.features || device.features.length === 0) && (
                    <div class={cx('text-center', 'font-italic', 'mt-3', style.featureListBody)}>
                      <Text id="integration.awox.device.noFeatureDiscovered" />
                    </div>
                  )}
                </div>
                <div class="form-group">
                  <button onClick={this.saveDevice} class="btn btn-success mr-2">
                    <Text id="integration.awox.device.saveButton" />
                  </button>
                  <button onClick={this.deleteDevice} class="btn btn-danger">
                    <Text id="integration.awox.device.deleteButton" />
                  </button>
                  <Link href={`/dashboard/integration/device/awox/${device.selector}`}>
                    <button class="btn btn-secondary float-right">
                      <Text id="integration.awox.device.editButton" />
                    </button>
                  </Link>
                </div>
              </div>
