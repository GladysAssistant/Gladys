...
const ArduinoFeatureBox = ({ children, ...props }) => {
  return (
    <div class="col-md-6">
      <div class="card">
        ...
        <div class="card-body">
          <div class="form-group form-label" for={`featureName_${props.featureIndex}`}>
            <label>
              <Text id="integration.arduino.feature.nameLabel" />
            </label>
            <Localizer>
              <input
                ...
                class="form-control"
                placeholder={<Text id="integration.arduino.feature.namePlaceholder" />}
              />
            </Localizer>
          </div>
          ...
          <div class="form-group">
            <label class="form-label" for={`externalid_${props.featureIndex}`}>
              <Text id="integration.arduino.feature.externalIdLabel" />
            </label>
            <Localizer>
              <input
                ...
                class="form-control"
                placeholder={<Text id="integration.arduino.feature.externalIdPlaceholder" />}
              />
            </Localizer>
          </div>
          ...
          {props.feature.category === DEVICE_FEATURE_CATEGORIES.TEMPERATURE_SENSOR && (
            <div class="form-group">
              <label class="form-label" for={`externalid_${props.featureIndex}`}>
                <Text id="integration.arduino.feature.unitLabel" />
              </label>
              <Localizer>
                <select
          ...
          <div class="form-group">
            <label class="form-label" for={`min_${props.featureIndex}`}>
              <Text id="integration.arduino.feature.minLabel" />
            </label>
            <Localizer>
              <input
                ...
                class="form-control"
                placeholder={<Text id="integration.arduino.feature.minPlaceholder" />}
              />
            </Localizer>
          </div>
          <div class="form-group">
            <label class="form-label" for={`max_${props.featureIndex}`}>
              <Text id="integration.arduino.feature.maxLabel" />
            </label>
            <Localizer>
              <input
                ...
                class="form-control"
                placeholder={<Text id="integration.arduino.feature.maxPlaceholder" />}
              />
            </Localizer>
          </div>
          ...
          <div class="form-group">
            <button onClick={props.deleteFeature} class="btn btn-outline-danger">
              <Text id="integration.arduino.feature.deleteLabel" />
            </button>
          </div>
        </div>
      </div>
...
class ArduinoFeatureBoxComponent extends Component {
  updateName = e => {
...
export default ArduinoFeatureBoxComponent;
