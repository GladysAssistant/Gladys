...
class EnergyMonitoringPage extends Component {
  ...
  getRecalculationCandidates() {
    ...
    const rootTypes = new Set([DEVICE_FEATURE_TYPES.ENERGY_SENSOR.ENERGY, DEVICE_FEATURE_TYPES.ENERGY_SENSOR.INDEX]);
    ...
    all.forEach(feature => {
      if (!feature || feature.category !== DEVICE_FEATURE_CATEGORIES.ENERGY_SENSOR || !rootTypes.has(feature.type)) {
        return;
      }
