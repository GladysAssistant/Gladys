...
const SonoffPage = ({ children, ...props }) => (
  <div class="page">
    <div class="page-main">
            ...
            <div class="col-lg-12">
              <div class="card">
                <div class="card-header">
                  <h1 class="card-title">
                    <Text id="integration.sonoff.title" />
                  </h1>
                    ...
                    <div class="input-icon ml-2">
                      ...
                      <Localizer>
                        <input
                          ...
                          placeholder={<Text id="integration.sonoff.search" />}
                          onInput={props.debouncedSearch}
                        />
                      </Localizer>
                    </div>
                    <button onClick={props.addDevice} class="btn btn-outline-primary ml-2">
                      <Text id="integration.sonoff.newButton" /> <i class="fe fe-plus" />
                    </button>
                  </div>
                </div>
                <div class="card-body">
                      ...
                      <div class="row">
                        {props.sonoffDevices &&
                          props.sonoffDevices.map((device, index) => (
                            <SonoffBox {...props} device={device} deviceIndex={index} />
                          ))}
