            ...
            <div class="col-lg-3">
              ...
              <div>
                <div class="list-group list-group-transparent mb-0">
                  <Link
                    href="/dashboard/integration/device/lan-manager"
                  ...
                  <Link
                    href="/dashboard/integration/device/lan-manager/discover"
                    activeClassName="active"
                    class="list-group-item list-group-item-action d-flex align-items-center"
                  >
                    <span class="icon mr-3">
                  ...
                  <Link
                    href="/dashboard/integration/device/lan-manager/config"
                    activeClassName="active"
                    class="list-group-item list-group-item-action d-flex align-items-center"
                  >
                    <span class="icon mr-3">
