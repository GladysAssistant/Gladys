...
class SunSpecIPLine extends Component {
  toggleStatus = () => {
        ...
        <td>
          <Localizer>
            <button
              ...
              title={
                editable ? (
                  <Text id="integration.sunspec.setup.deleteButtonTooltip" />
                ) : (
                  <Text id="integration.sunspec.setup.networkInterfaceDescription" />
                )
              }
            >
              <i class="fe fe-trash" />
