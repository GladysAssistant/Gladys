...
const data = {
  ...
  'get /api/v1/device_feature/states_history': [
    ...
    {
      value: 0,
      created_at: dayjs().subtract(9, 'minute').toISOString(),
      device_feature: {
        name: 'Opening',
    ...
    {
      value: 1,
      created_at: dayjs().subtract(42, 'minute').toISOString(),
      device_feature: {
        name: 'On/Off',
    ...
    {
      value: 52,
      created_at: dayjs().subtract(55, 'minute').toISOString(),
      device_feature: {
        name: 'Humidity',
        selector: 'humidity-sensor',
        category: 'humidity-sensor',
    ...
    {
      value: 1,
      created_at: dayjs().subtract(1, 'day').subtract(2, 'hour').toISOString(),
      device_feature: {
        name: 'Click',
    ...
    {
      value: 0,
      created_at: dayjs().subtract(1, 'day').subtract(3, 'hour').toISOString(),
      device_feature: {
        name: 'Opening',
        selector: 'demo-front-door-opening',
        category: 'opening-sensor',
  ...
  'get /api/v1/message': [
    ...
    },
    {
      ...
      is_read: true,
      created_at: dayjs().subtract(1, 'hour').subtract(1, 'seconds').toISOString(),
    },
    {
      id: '247b1dd0-6fab-47a8-a9c8-1405deae0ae8',
      sender_id: null,
      ...
      is_read: true,
      created_at: dayjs().subtract(1, 'hour').subtract(2, 'seconds').toISOString(),
    },
    {
      id: '247b1dd0-6fab-47a8-a9c8-1405deae0ae8',
      sender_id: '0cd30aef-9c4e-4a23-88e3-3547971296e5',
      ...
      is_read: true,
      created_at: dayjs().subtract(1, 'hour').subtract(3, 'seconds').toISOString(),
    },
  ],
  'post /api/v1/message': {
    id: '247b1dd0-6fab-47a8-a9c8-1405deae0ae8',
  ...
  'get /api/v1/gateway/instance/key': {
    ...
    ecdsa_fingerprint:
      '42:b0:74:47:b5:60:14:a0:37:94:db:83:2d:de:a4:51:58:ad:6f:c9:6e:6f:0b:54:82:d1:f3:bf:cf:99:6c:3f',
  },
  ...
  'get /api/v1/device_feature/aggregated_states?interval=43200&max_states=100&device_features=temperature-sensor-1': [
    {
      ...
      values: [
        ...
        {
          created_at: dayjs().subtract(11, 'day').toISOString(),
          value: 35,
        },
        {
        ...
        {
          created_at: dayjs().subtract(13, 'day').toISOString(),
          value: 35,
        },
        {
        ...
        {
          created_at: dayjs().subtract(17, 'day').toISOString(),
          value: 61,
        },
        {
        ...
        {
          created_at: dayjs().subtract(21, 'day').toISOString(),
          value: 19,
        },
        {
          created_at: dayjs().subtract(22, 'day').toISOString(),
          value: 46,
        },
        {
          created_at: dayjs().subtract(23, 'day').toISOString(),
          value: 39,
        },
        {
          created_at: dayjs().subtract(24, 'day').toISOString(),
          value: 62,
        },
        {
        ...
        {
          created_at: dayjs().subtract(26, 'day').toISOString(),
          value: 35,
        },
        {
          created_at: dayjs().subtract(27, 'day').toISOString(),
          value: 41,
        },
        {
          created_at: dayjs().subtract(28, 'day').toISOString(),
          value: 33,
        },
      ],
    },
