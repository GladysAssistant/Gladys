...
const home = {
  ...
  'post /api/v1/house/main-house/presence_arm': { ...house, alarm_mode: 'presence-armed' },
  'post /api/v1/house/main-house/night_arm': { ...house, alarm_mode: 'night-armed' },
  'post /api/v1/house/main-house/away_arm': { ...house, alarm_mode: 'away-armed' },
  'post /api/v1/house/main-house/disarm': { ...house, alarm_mode: 'disarmed' },
  'post /api/v1/house/main-house/panic': { ...house, alarm_mode: 'triggered' },
