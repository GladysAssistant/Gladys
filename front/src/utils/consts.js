...
export const DeviceFeatureCategoriesIcon = {
  ...
  [DEVICE_FEATURE_CATEGORIES.AIR_CONDITIONING]: {
    ...
    [DEVICE_FEATURE_TYPES.AIR_CONDITIONING.TEMPERATURE]: 'thermometer',
  ...
  [DEVICE_FEATURE_CATEGORIES.CHARGER]: {
    [DEVICE_FEATURE_TYPES.CHARGER.BINARY]: 'power',
    [DEVICE_FEATURE_TYPES.CHARGER.POWER]: 'zap',
    [DEVICE_FEATURE_TYPES.CHARGER.ENERGY]: 'zap',
    [DEVICE_FEATURE_TYPES.CHARGER.CURRENT]: 'zap',
    [DEVICE_FEATURE_TYPES.CHARGER.VOLTAGE]: 'zap',
    [DEVICE_FEATURE_TYPES.CHARGER.TARGET_CURRENT]: 'zap'
  },
};
