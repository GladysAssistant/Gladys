...
export const DeviceFeatureCategoriesIcon = {
  ...
  [DEVICE_FEATURE_CATEGORIES.HEALTH]: {
    [DEVICE_FEATURE_TYPES.HEALTH.BODY_TEMPERATURE]: 'thermometer',
    [DEVICE_FEATURE_TYPES.HEALTH.BONE_MASS]: 'grid',
    [DEVICE_FEATURE_TYPES.HEALTH.DIASTOLIC_BLOOD_PRESSURE]: 'droplet',
    [DEVICE_FEATURE_TYPES.HEALTH.FAT_FREE_MASS]: 'grid',
    [DEVICE_FEATURE_TYPES.HEALTH.FAT_MASS_WEIGHT]: 'grid',
    [DEVICE_FEATURE_TYPES.HEALTH.FAT_RATIO]: 'percent',
    [DEVICE_FEATURE_TYPES.HEALTH.HEARTH_PULSE]: 'activity',
    [DEVICE_FEATURE_TYPES.HEALTH.HEIGHT]: 'grid',
    [DEVICE_FEATURE_TYPES.HEALTH.HYDRATION]: 'droplet',
    [DEVICE_FEATURE_TYPES.HEALTH.MUSCLE_MASS]: 'grid',
    [DEVICE_FEATURE_TYPES.HEALTH.PULSE_WAVE_VELOCITY]: 'activity',
    [DEVICE_FEATURE_TYPES.HEALTH.SKIN_TEMPERATURE]: 'thermometer',
    [DEVICE_FEATURE_TYPES.HEALTH.SPO2]: 'cloud',
    [DEVICE_FEATURE_TYPES.HEALTH.SYSTOLIC_BLOOD_PRESSURE]: 'droplet',
    [DEVICE_FEATURE_TYPES.HEALTH.TEMPERATURE]: 'thermometer',
    [DEVICE_FEATURE_TYPES.HEALTH.WEIGHT]: 'grid'
  },
