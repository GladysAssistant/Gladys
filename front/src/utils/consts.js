...
export const DeviceFeatureCategoriesIcon = {
  ...
  [DEVICE_FEATURE_CATEGORIES.ELECTRICAL_VEHICLE]: {
    [DEVICE_FEATURE_TYPES.ELECTRICAL_VEHICLE.ALARM]: 'bell',
    [DEVICE_FEATURE_TYPES.ELECTRICAL_VEHICLE.BATTERY]: 'battery',
    [DEVICE_FEATURE_TYPES.ELECTRICAL_VEHICLE.BATTERY_POWER]: 'zap',
    [DEVICE_FEATURE_TYPES.ELECTRICAL_VEHICLE.BATTERY_RANGE_EST]: 'battery',
    [DEVICE_FEATURE_TYPES.ELECTRICAL_VEHICLE.BATTERY_TEMP]: 'thermometer',
    [DEVICE_FEATURE_TYPES.ELECTRICAL_VEHICLE.BATTERY_VOLTAGE]: 'zap',
    [DEVICE_FEATURE_TYPES.ELECTRICAL_VEHICLE.CHARGE_CURRENT]: 'zap',
    [DEVICE_FEATURE_TYPES.ELECTRICAL_VEHICLE.CHARGE_ENERGY_ADDED]: 'zap',
    [DEVICE_FEATURE_TYPES.ELECTRICAL_VEHICLE.CHARGE_ENERGY_CONSUMPTION]: 'zap',
    [DEVICE_FEATURE_TYPES.ELECTRICAL_VEHICLE.CHARGE_ON]: 'power',
    [DEVICE_FEATURE_TYPES.ELECTRICAL_VEHICLE.CHARGE_POWER]: 'zap',
    [DEVICE_FEATURE_TYPES.ELECTRICAL_VEHICLE.CHARGE_VOLTAGE]: 'zap',
    [DEVICE_FEATURE_TYPES.ELECTRICAL_VEHICLE.CLIMATE_ON]: 'power',
    [DEVICE_FEATURE_TYPES.ELECTRICAL_VEHICLE.DOOR_OPEN]: 'unlock',
    [DEVICE_FEATURE_TYPES.ELECTRICAL_VEHICLE.ENERGY_CONSUMPTION]: 'zap',
    [DEVICE_FEATURE_TYPES.ELECTRICAL_VEHICLE.ENERGY_CONSUMPTION_TOTAL]: 'zap',
    [DEVICE_FEATURE_TYPES.ELECTRICAL_VEHICLE.ENERGY_EFFICIENCY]: 'zap',
    [DEVICE_FEATURE_TYPES.ELECTRICAL_VEHICLE.ENERGY_REMAINING]: 'zap',
    [DEVICE_FEATURE_TYPES.ELECTRICAL_VEHICLE.INDOOR_TEMP]: 'thermometer',
    [DEVICE_FEATURE_TYPES.ELECTRICAL_VEHICLE.LOCK]: 'lock',
    [DEVICE_FEATURE_TYPES.ELECTRICAL_VEHICLE.NAME]: 'tag',
    [DEVICE_FEATURE_TYPES.ELECTRICAL_VEHICLE.VIN]: 'tag',
    [DEVICE_FEATURE_TYPES.ELECTRICAL_VEHICLE.ODOMETER]: 'trending-up',
    [DEVICE_FEATURE_TYPES.ELECTRICAL_VEHICLE.PLUGGED]: 'power',
    [DEVICE_FEATURE_TYPES.ELECTRICAL_VEHICLE.TARGET_CHARGE_LIMIT_SOC]: 'zap',
    [DEVICE_FEATURE_TYPES.ELECTRICAL_VEHICLE.TARGET_CURRENT]: 'zap',
    [DEVICE_FEATURE_TYPES.ELECTRICAL_VEHICLE.TARGET_TEMPERATURE]: 'thermometer',
    [DEVICE_FEATURE_TYPES.ELECTRICAL_VEHICLE.WINDOW_OPEN]: 'square'
  }
};
