...
export const DeviceFeatureCategoriesIcon = {
  ...
  [DEVICE_FEATURE_CATEGORIES.LIGHT]: {
    [DEVICE_FEATURE_TYPES.LIGHT.BINARY]: 'bulb',
    [DEVICE_FEATURE_TYPES.LIGHT.BRIGHTNESS]: 'brightness-half',
    [DEVICE_FEATURE_TYPES.LIGHT.HUE]: 'color-filter',
    [DEVICE_FEATURE_TYPES.LIGHT.COLOR]: 'color-filter',
    [DEVICE_FEATURE_TYPES.LIGHT.SATURATION]: 'sun',
    [DEVICE_FEATURE_TYPES.LIGHT.TEMPERATURE]: 'temperature',
  ...
  [DEVICE_FEATURE_CATEGORIES.DEVICE_TEMPERATURE_SENSOR]: {
    [DEVICE_FEATURE_TYPES.SENSOR.DECIMAL]: 'cpu-2'
  },
  ...
  [DEVICE_FEATURE_CATEGORIES.TELEVISION]: {
    ...
    [DEVICE_FEATURE_TYPES.TELEVISION.REWIND]: 'player-skip-rewind',
    [DEVICE_FEATURE_TYPES.TELEVISION.FORWARD]: 'player-skip-forward',
    [DEVICE_FEATURE_TYPES.TELEVISION.RECORD]: 'player-record'
  },
  [DEVICE_FEATURE_CATEGORIES.SHUTTER]: {
    [DEVICE_FEATURE_TYPES.SHUTTER.STATE]: 'elevator',
    [DEVICE_FEATURE_TYPES.SHUTTER.POSITION]: 'adjustments'
  },
  [DEVICE_FEATURE_CATEGORIES.CURTAIN]: {
    [DEVICE_FEATURE_TYPES.CURTAIN.STATE]: 'elevator',
    [DEVICE_FEATURE_TYPES.CURTAIN.POSITION]: 'adjustments'
  },
  ...
  [DEVICE_FEATURE_CATEGORIES.ENERGY_SENSOR]: {
    ...
    [DEVICE_FEATURE_TYPES.ENERGY_SENSOR.CURRENT]: 'circuit-ammeter',
    [DEVICE_FEATURE_TYPES.ENERGY_SENSOR.VOLTAGE]: 'circuit-voltmeter',
    [DEVICE_FEATURE_TYPES.ENERGY_SENSOR.INDEX]: 'receipt'
  },
  [DEVICE_FEATURE_CATEGORIES.SPEED_SENSOR]: {
    [DEVICE_FEATURE_TYPES.SPEED_SENSOR.DECIMAL]: 'wind'
  },
  [DEVICE_FEATURE_CATEGORIES.UV_SENSOR]: {
    [DEVICE_FEATURE_TYPES.UV_SENSOR.INTEGER]: 'uv-index'
  },
  ...
  [DEVICE_FEATURE_CATEGORIES.VOLUME_SENSOR]: {
    [DEVICE_FEATURE_TYPES.VOLUME_SENSOR.DECIMAL]: '3d-cube-sphere',
    [DEVICE_FEATURE_TYPES.VOLUME_SENSOR.INTEGER]: '3d-cube-sphere'
  },
  ...
  [DEVICE_FEATURE_CATEGORIES.THERMOSTAT]: {
    [DEVICE_FEATURE_TYPES.THERMOSTAT.TARGET_TEMPERATURE]: 'flame'
  },
