...
export const DeviceFeatureCategoriesIcon = {
  ...
  [DEVICE_FEATURE_CATEGORIES.SISMIC_SENSOR]: 'activity',
  [DEVICE_FEATURE_CATEGORIES.LIGHT]: 'sun ',
  [DEVICE_FEATURE_CATEGORIES.TEMPERATURE_SENSOR]: 'thermometer',
  [DEVICE_FEATURE_CATEGORIES.LIGHT_SENSOR]: 'sun',
  [DEVICE_FEATURE_CATEGORIES.SWITCH]: 'power',
  [DEVICE_FEATURE_CATEGORIES.SMOKE_SENSOR]: 'wind',
  [DEVICE_FEATURE_CATEGORIES.SIREN]: 'bell',
  [DEVICE_FEATURE_CATEGORIES.ACCESS_CONTROl]: 'lock',
