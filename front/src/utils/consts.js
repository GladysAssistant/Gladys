...
export const DeviceFeatureCategoriesIcon = {
  ...
  [DEVICE_FEATURE_CATEGORIES.WITHINGS]: {
    [DEVICE_FEATURE_TYPES.WITHINGS.BATTERY]: 'battery',
    [DEVICE_FEATURE_TYPES.WITHINGS.BODY_TEMPERATURE]: 'thermometer',
    [DEVICE_FEATURE_TYPES.WITHINGS.BONE_MASS]: 'grid',
    [DEVICE_FEATURE_TYPES.WITHINGS.DIASTOLIC_BLOOD_PRESSURE]: 'droplet',
    [DEVICE_FEATURE_TYPES.WITHINGS.FAT_FREE_MASS]: 'grid',
    [DEVICE_FEATURE_TYPES.WITHINGS.FAT_MASS_WEIGHT]: 'grid',
    [DEVICE_FEATURE_TYPES.WITHINGS.FAT_RATIO]: 'percent',
    [DEVICE_FEATURE_TYPES.WITHINGS.HEARTH_PULSE]: 'activity',
    [DEVICE_FEATURE_TYPES.WITHINGS.HEIGHT]: 'grid',
    [DEVICE_FEATURE_TYPES.WITHINGS.HYDRATION]: 'droplet',
    [DEVICE_FEATURE_TYPES.WITHINGS.MUSCLE_MASS]: 'grid',
    [DEVICE_FEATURE_TYPES.WITHINGS.PULSE_WAVE_VELOCITY]: 'activity',
    [DEVICE_FEATURE_TYPES.WITHINGS.SKIN_TEMPERATURE]: 'thermometer',
    [DEVICE_FEATURE_TYPES.WITHINGS.SPO2]: 'cloud',
    [DEVICE_FEATURE_TYPES.WITHINGS.SYSTOLIC_BLOOD_PRESSURE]: 'droplet',
    [DEVICE_FEATURE_TYPES.WITHINGS.TEMPERATURE]: 'thermometer',
    [DEVICE_FEATURE_TYPES.WITHINGS.WEIGHT]: 'grid'
  },
