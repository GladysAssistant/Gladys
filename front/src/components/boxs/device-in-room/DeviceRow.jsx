...
const ROW_TYPE_BY_CATEGORY_AND_TYPE = {
  ...
  [DEVICE_FEATURE_CATEGORIES.TELEVISION]: {
    ...
    [DEVICE_FEATURE_TYPES.TELEVISION.UP]: PushDeviceFeature,
    [DEVICE_FEATURE_TYPES.TELEVISION.DOWN]: PushDeviceFeature,
    [DEVICE_FEATURE_TYPES.TELEVISION.LEFT]: PushDeviceFeature,
    [DEVICE_FEATURE_TYPES.TELEVISION.RIGHT]: PushDeviceFeature,
    [DEVICE_FEATURE_TYPES.TELEVISION.ENTER]: PushDeviceFeature,
    [DEVICE_FEATURE_TYPES.TELEVISION.RETURN]: PushDeviceFeature
  }
};
