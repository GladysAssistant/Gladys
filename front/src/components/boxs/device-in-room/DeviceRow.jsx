...
const ROW_TYPE_BY_FEATURE_TYPE = {
  ...
  [DEVICE_FEATURE_TYPES.ELECTRICAL_VEHICLE.ALARM]: BinaryDeviceFeature,
  [DEVICE_FEATURE_TYPES.ELECTRICAL_VEHICLE.CHARGE_ON]: BinaryDeviceFeature,
  [DEVICE_FEATURE_TYPES.ELECTRICAL_VEHICLE.CLIMATE_ON]: BinaryDeviceFeature,
  [DEVICE_FEATURE_TYPES.ELECTRICAL_VEHICLE.LOCK]: BinaryDeviceFeature,
  [DEVICE_FEATURE_TYPES.ELECTRICAL_VEHICLE.TARGET_CURRENT]: CurrentSetpointDeviceFeature,
  [DEVICE_FEATURE_TYPES.ELECTRICAL_VEHICLE.TARGET_TEMPERATURE]: ThermostatDeviceFeature,
  [DEVICE_FEATURE_TYPES.ELECTRICAL_VEHICLE.TARGET_CHARGE_LIMIT_SOC]: MultiLevelDeviceFeature,
};
