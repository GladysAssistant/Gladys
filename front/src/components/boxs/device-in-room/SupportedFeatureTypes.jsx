...
const SUPPORTED_FEATURE_TYPES = [
  ...
  DEVICE_FEATURE_TYPES.ELECTRICAL_VEHICLE.TARGET_CURRENT,
  DEVICE_FEATURE_TYPES.ELECTRICAL_VEHICLE.TARGET_TEMPERATURE,
  DEVICE_FEATURE_TYPES.ELECTRICAL_VEHICLE.TARGET_CHARGE_LIMIT_SOC,
];
