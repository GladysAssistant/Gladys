...
const DISPLAY_BY_FEATURE_TYPE = {
  ...
  [DEVICE_FEATURE_TYPES.ELECTRICAL_VEHICLE.DOOR_OPEN]: IconBinaryDeviceValue,
  [DEVICE_FEATURE_TYPES.ELECTRICAL_VEHICLE.NAME]: TextDeviceValue,
  [DEVICE_FEATURE_TYPES.ELECTRICAL_VEHICLE.PLUGGED]: IconBinaryDeviceValue,
  [DEVICE_FEATURE_TYPES.ELECTRICAL_VEHICLE.VIN]: TextDeviceValue,
  [DEVICE_FEATURE_TYPES.ELECTRICAL_VEHICLE.WINDOW_OPEN]: IconBinaryDeviceValue,
};
