    ...
    {props.weather && (
      <div style={padding} class="card-block px-30 py-10">
        ...
        <div class="row">
          ...
          >
            <i
              className={cx('lucide', props.weatherIcon)}
              style={{
                fontSize: '50px'
              }}
            />
          ...
          return (
            <div style={Object.assign({ width: '10%', margin: '0.25em 1.25%' })}>
              ...
              <p style={{ margin: 'auto', textAlign: 'center' }}>
                <i className={cx('lucide', hour.weatherIcon)} style={{ fontSize: '20px' }} />
              </p>
        ...
        daysDisplay = days.map(day => {
          return (
            <div className="row" style={{ marginTop: '0.5em' }}>
              ...
              <div className="col-3">
                <i className={cx('lucide', day.weatherIcon)} style={{ fontSize: '20px' }} />
              </div>
