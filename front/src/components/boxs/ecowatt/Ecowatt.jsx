                ...
                hours.map(hour => (
                  <div style={{ width: '10%', margin: '0.25em 1.25%' }}>
                    ...
                    <p style={{ margin: 'auto', textAlign: 'center' }}>
                      {hour.data === 1 && <i class="icon-check" style={{ fontSize: '20px', color: '#00b894' }} />}
                      {hour.data === 2 && (
                        <i class="icon-circle-alert" style={{ fontSize: '20px', color: '#fdcb6e' }} />
                      )}
                      {hour.data === 3 && (
                        <i class="icon-triangle-alert" style={{ fontSize: '20px', color: '#d63031' }} />
                      )}
                    </p>
                  </div>
                ))}
