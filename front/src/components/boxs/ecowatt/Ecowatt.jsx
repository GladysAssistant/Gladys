...
const EcowattBox = ({ hours, days, loading }) => (
  <div class="card">
              ...
              hours.map(hour => (
                <div style={{ width: '10%', margin: '0.25em 1.25%' }}>
                  ...
                  <p style={{ margin: 'auto', textAlign: 'center' }}>
                    ...
                    {hour.data === 2 && <i class="fe fe-alert-circle" style={{ fontSize: '20px', color: '#fdcb6e' }} />}
                    {hour.data === 3 && (
...
class Ecowatt extends Component {
  refreshData = async () => {
    ...
    this.setState({ hours, days, loading: false });
  };
  ...
  render({}, { hours, days, loading }) {
    return <EcowattBox hours={hours} days={days} loading={loading} />;
  }
}
