...
#### [v3.11.6](https://github.com/GladysProject/Gladys/compare/v3.11.5...v3.11.6)
> 7 December 2018
- Copy hooks assets not only in api/hooks folder but in production and tmp folder too [`9131b1a`](https://github.com/GladysProject/Gladys/commit/9131b1ae7722d9e50265fab0421da0b4edfcb51d)

#### [v3.11.5](https://github.com/GladysProject/Gladys/compare/v3.11.4...v3.11.5)
> 6 December 2018
- Update Changelog for Gladys v3.11.4 [`7693067`](https://github.com/GladysProject/Gladys/commit/76930675b487cfb9afb20ab4c408f25a62799104)
- Add database migration to 3.11.5 to add column color to table area [`f8de99d`](https://github.com/GladysProject/Gladys/commit/f8de99d738264a30ca0709508de6ce51f9b67a00)

#### [v3.11.4](https://github.com/GladysProject/Gladys/compare/v3.11.3...v3.11.4)
> 3 December 2018
- Add nmap to Dockerfile for some modules [`#452`](https://github.com/GladysProject/Gladys/pull/452)
- Test against current version of Node.js in Travis [`#451`](https://github.com/GladysProject/Gladys/pull/451)
- Adding the color-picker and push-button to the device-room box [`#445`](https://github.com/GladysProject/Gladys/pull/445)
- Specify utf8 when creating mysql db for dev mode [`#444`](https://github.com/GladysProject/Gladys/pull/444)
- Improve devices curves view in UI [`#443`](https://github.com/GladysProject/Gladys/pull/443)
- Add gladys.event.purgeByEventType function [`#442`](https://github.com/GladysProject/Gladys/pull/442)
- Create Dockerfile.arm32v7 [`#435`](https://github.com/GladysProject/Gladys/pull/435)
- Fix #356: Notification/Messages are always sent through websocket by default. [`#356`](https://github.com/GladysProject/Gladys/issues/356)
- Fix #433 : add fallback to house in weather get command [`#433`](https://github.com/GladysProject/Gladys/issues/433)
- Fix #453 : Add ability to edit house/room in UI [`#453`](https://github.com/GladysProject/Gladys/issues/453)
- Fix #446: Display more rooms in UI when account has many rooms [`#446`](https://github.com/GladysProject/Gladys/issues/446)
- Close #457 : Improve TV API with more functions &amp; detection of available functions [`#457`](https://github.com/GladysProject/Gladys/issues/457)
- Close #454 : Add getDeviceTypeByCategory route in device service + filter device by service [`#454`](https://github.com/GladysProject/Gladys/issues/454)
- Close #456 : REST API now exposes GET /module/method route to get available function from module [`#456`](https://github.com/GladysProject/Gladys/issues/456)
- Close #450 : Add ability to create notification from REST API [`#450`](https://github.com/GladysProject/Gladys/issues/450)
- Close #449 : Add ability to track user location in the past between date range [`#449`](https://github.com/GladysProject/Gladys/issues/449)
- Close #441 &amp; #369 : Check if user has left area now takes accuracy into account [`#441`](https://github.com/GladysProject/Gladys/issues/441)
- Close #437 : house.checkUserPresence is now started automatically with default values [`#437`](https://github.com/GladysProject/Gladys/issues/437)
- Closes #410 : Add function gladys.deviceType.getByTag(options); [`#410`](https://github.com/GladysProject/Gladys/issues/410)
- Fix #448 : Increase maxBuffer size when installing NPM dependency of module [`#448`](https://github.com/GladysProject/Gladys/issues/448)
- Remove istanbul (no longer up to date) and use just mocha instead to run tests [`8e441d8`](https://github.com/GladysProject/Gladys/commit/8e441d895844f88baf0fbf8eb2bfd456d8683386)
- Update gladys-gateway-js to 1.0.7 to fix Gladys Gateway disconnect errors on flaky connection [`9bac5fc`](https://github.com/GladysProject/Gladys/commit/9bac5fcf9f5d6c75777e97e4025b2bc1f7350f13)
- Fix areas tests [`9629df2`](https://github.com/GladysProject/Gladys/commit/9629df225f4bdd7d0892f9557545e9377e2e9646)

#### [v3.11.3](https://github.com/GladysProject/Gladys/compare/v3.11.2...v3.11.3)
> 2 November 2018
- update gladys-gateway-js to 1.0.5 [`40ce3ab`](https://github.com/GladysProject/Gladys/commit/40ce3abd3c6ac6bc4659c29a3655c5a0c23f0965)

#### [v3.11.2](https://github.com/GladysProject/Gladys/compare/v3.11.1...v3.11.2)
> 1 November 2018
- Gladys Gateway is now more resilient to network failure. [`06d5fb7`](https://github.com/GladysProject/Gladys/commit/06d5fb732a69acfc014a16600be93b3feab829b1)
- Fix linting issues [`b05e203`](https://github.com/GladysProject/Gladys/commit/b05e2030cd6081d328c144a7750aa21c0841edf6)

#### [v3.11.1](https://github.com/GladysProject/Gladys/compare/v3.11.0...v3.11.1)
> 31 October 2018
- Bugfix gateway: generate fingerprint with webcrypto API as well in handleMessage [`e9a7a8f`](https://github.com/GladysProject/Gladys/commit/e9a7a8f82f7eb0dfd5df79dfb9f7917cf97da0bc)
- load users keys after login [`9ea2966`](https://github.com/GladysProject/Gladys/commit/9ea2966e207846424c9e6fef6b278bc0e86eb2d2)
- hide user list when gladys gateway is not connected [`2199252`](https://github.com/GladysProject/Gladys/commit/2199252c46b8b793164a292a94d60bb798d9447b)

#### [v3.11.0](https://github.com/GladysProject/Gladys/compare/v3.10.3...v3.11.0)
> 31 October 2018
- Fix display joystick display bug on television box [`#434`](https://github.com/GladysProject/Gladys/pull/434)
- hash gladys-gateway with webcrypto api rather than node.js [`d0bd96a`](https://github.com/GladysProject/Gladys/commit/d0bd96a97981c5627562c44ae25c7e61ef534ff9)
- Add icons to layout [`1a13063`](https://github.com/GladysProject/Gladys/commit/1a13063db28019e8ceae6293bf1f31fc4ec5bd4b)
- add db migration for v3.11.0 [`28c3795`](https://github.com/GladysProject/Gladys/commit/28c37957e91c072bf86289d67a50cdfcb226ea16)

#### [v3.10.3](https://github.com/GladysProject/Gladys/compare/v3.10.2...v3.10.3)
> 14 October 2018
- Rolling back bcrypt to 3.0.0 [`fa3e6e9`](https://github.com/GladysProject/Gladys/commit/fa3e6e945b0d69845d6fdfbb4ff181d0d2094353)

#### [v3.10.2](https://github.com/GladysProject/Gladys/compare/v3.10.1...v3.10.2)
> 12 October 2018
- updateAllData need user object [`13b2e5c`](https://github.com/GladysProject/Gladys/commit/13b2e5ceb41a9cd52a085d5e4f48534dbc60e9fd)

#### [v3.10.1](https://github.com/GladysProject/Gladys/compare/v3.10.0...v3.10.1)
> 12 October 2018
- add updateAllData function + update all data at update of Gladys v3.10.1 [`693d33d`](https://github.com/GladysProject/Gladys/commit/693d33d9d5c0a5caf94441df9f1857632ca9081c)
- docker every single version as well as major version [`c40ab0e`](https://github.com/GladysProject/Gladys/commit/c40ab0e3a0919fb71e751b73fad2b090ee455852)

#### [v3.10.0](https://github.com/GladysProject/Gladys/compare/v3.9.1...v3.10.0)
> 12 October 2018
- When creating an event, return name and code in object [`#398`](https://github.com/GladysProject/Gladys/pull/398)
- 🔧 Update .travis.yml to manage docker build [`#387`](https://github.com/GladysProject/Gladys/pull/387)
- Emit event gladys-launched at startup. [`#425`](https://github.com/GladysProject/Gladys/pull/425)
- Fix #362 : Add push button in UI [`#430`](https://github.com/GladysProject/Gladys/pull/430)
- Fix #413 : Improve detection of devicetype by the brain [`#432`](https://github.com/GladysProject/Gladys/pull/432)
- Correction of the slider width to no longer display the horizontal scroll + doc for deviceType.getByCategory [`#414`](https://github.com/GladysProject/Gladys/pull/414)
- Update jsdoc.js to add gladys.area.userIn [`#420`](https://github.com/GladysProject/Gladys/pull/420)
- Fix #361 Multiple slide are no longer overriding each other [`#409`](https://github.com/GladysProject/Gladys/pull/409)
- Fix issue #412: Area behavior has been completely rewritten [`#419`](https://github.com/GladysProject/Gladys/pull/419)
- Fix JS doc [`#418`](https://github.com/GladysProject/Gladys/pull/418)
- Close #400 : add trueIf condition option to reverse conditions [`#400`](https://github.com/GladysProject/Gladys/issues/400)
- Close #403 : Add house.isMode function to test if house is in current mode [`#403`](https://github.com/GladysProject/Gladys/issues/403)
- Fix #301 : Gladys now send a notification when a module is updated [`#301`](https://github.com/GladysProject/Gladys/issues/301)
- Fix #391 : Module assets are now copied in both www and .tmp folder are install/removed at uninstall [`#391`](https://github.com/GladysProject/Gladys/issues/391)
- Fix #411 : add television native API in Gladys [`#411`](https://github.com/GladysProject/Gladys/issues/411)
- Fix #300: Add new colorpicker for deviceTypes (#404) [`#300`](https://github.com/GladysProject/Gladys/issues/300)
- Add contributing link in README [`49356cb`](https://github.com/GladysProject/Gladys/commit/49356cb2abdb113850ea820725d7892ced5360bc)
- add db migration to v3.10.0 [`60449c4`](https://github.com/GladysProject/Gladys/commit/60449c441e3d918e32d779ca7d84053e565ff48f)
- build documentation only on master [`2e89fa9`](https://github.com/GladysProject/Gladys/commit/2e89fa93571e3df4e2c8142b675faeaf169973ca)
