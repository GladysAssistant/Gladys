...
- **The bar is sticky**: it stays pinned while the dashboard scrolls under it — the pill track's backdrop blur frosts the passing cards (iOS-style floating capsule). It floats a small gap from the viewport edge on desktop, and right below the fixed mobile top bar (H2) on mobile.
