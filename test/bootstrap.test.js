...
function addTestModuleGladys(gladys){
    ...
    gladys.modules.test = {
        ...
        television: {
            switchState: function() {return Promise.resolve()},
            getState: function() {return Promise.resolve({state: 'on'})},
            setChannel: function() {return Promise.resolve()},
            getChannel: function() {return Promise.resolve([{channel:'1'}, {channel:'2'}, {channel:'3'}])},
            getCurrentChannel: function() {return Promise.resolve({channel:'1'})},
            getMuted: function() {return Promise.resolve([{mute:'1'}])},
            getVolume: function() {return Promise.resolve()},
            fastForward: function() {return Promise.resolve()},
            rewind: function() {return Promise.resolve()},
            pause: function() {return Promise.resolve()},
            play: function() {return Promise.resolve()},
            setMuted: function() {return Promise.resolve()},
            setVolume: function() {return Promise.resolve()},
            stop: function() {return Promise.resolve()},
            volumeUp: function() {return Promise.resolve()},
            volumeDown: function() {return Promise.resolve()},
            pressKey: function() {return Promise.resolve()},
            getSources: function() {return Promise.resolve([{label:'HDMI1'}, {label:'HDMI2'}, {label:'VGA'}])},
            openSource: function() {return Promise.resolve()},
            openMenu: function() {return Promise.resolve()},
            rec: function() {return Promise.resolve()},
            redButton: function() {return Promise.resolve()},
            greenButton: function() {return Promise.resolve()},
            yellowButton: function() {return Promise.resolve()},
            blueButton: function() {return Promise.resolve()},
        }
    };
