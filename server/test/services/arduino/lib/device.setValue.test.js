...
const deviceManager = {
  get: fake.resolves([arduinoData, deviceChaconData, deviceEmit433Data, dhtData]),
...
describe('setValue function', async () => {
  it('should set the value (ON for classic 433)', async () => {
    ...
    assert.calledOnce(setValueOnSpy);
    setValueOnSpy.restore();
  });
  it('should set the value (OFF for classic 433)', async () => {
    const arduinoManager = new ArduinoManager(ArduinoMock, 'de051f90-f34a-4fd5-be2e-e502339ec9bc');
    arduinoManager.gladys = gladys;
    const setValueOnSpy = spy(arduinoManager, 'setValue');
  ...
  it('should set the value (ON for chacon)', async () => {
    const arduinoManager = new ArduinoManager(ArduinoMock, 'de051f90-f34a-4fd5-be2e-e502339ec9bc');
    arduinoManager.gladys = gladys;
    const setValueOnSpy = spy(arduinoManager, 'setValue');
  ...
  it('should set the value (OFF for chacon)', async () => {
    const arduinoManager = new ArduinoManager(ArduinoMock, 'de051f90-f34a-4fd5-be2e-e502339ec9bc');
    arduinoManager.gladys = gladys;
    const setValueOnSpy = spy(arduinoManager, 'setValue');
