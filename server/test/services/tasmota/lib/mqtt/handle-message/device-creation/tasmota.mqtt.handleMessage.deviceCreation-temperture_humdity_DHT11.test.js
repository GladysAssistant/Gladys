...
const messages = require('../../../device-creation/DHT11.json');
...
describe('Tasmota - MQTT - create device with DHT11 temp/humidity features', () => {
  ...
  it('decode STATUS8 message', () => {
      ...
      features: [
        {
          ...
          external_id: 'tasmota:tasmota-device-topic:DHT11:Humidity',
          selector: 'tasmota-tasmota-device-topic-dht11-humidity',
          name: 'Humidity',
          read_only: true,
          has_feedback: false,
          min: 0,
        ...
        },
        {
          ...
          external_id: 'tasmota:tasmota-device-topic:DHT11:Temperature',
          selector: 'tasmota-tasmota-device-topic-dht11-temperature',
          name: 'Temperature',
          read_only: true,
          has_feedback: false,
          min: -100,
    ...
    assert.calledWith(gladys.event.emit, EVENTS.DEVICE.NEW_STATE, {
      device_feature_external_id: 'tasmota:tasmota-device-topic:DHT11:Temperature',
      state: 23,
    });
    assert.calledWith(gladys.event.emit, EVENTS.DEVICE.NEW_STATE, {
      device_feature_external_id: 'tasmota:tasmota-device-topic:DHT11:Humidity',
      state: 65,
    });
