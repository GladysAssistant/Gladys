...
const messages = require('../../../device-creation/VL53L0X.json');
...
describe('Tasmota - MQTT - create device with VL53L0X distance features', () => {
  ...
  it('decode STATUS8 message', () => {
    ...
    assert.calledWith(gladys.event.emit, EVENTS.DEVICE.NEW_STATE, {
      device_feature_external_id: 'tasmota:tasmota-device-topic:VL53L0X:Distance',
      state: 3.65,
    });
