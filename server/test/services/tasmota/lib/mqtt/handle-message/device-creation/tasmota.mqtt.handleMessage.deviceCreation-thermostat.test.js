...
const messages = require('../../../device-creation/thermostat.json');
...
describe('Tasmota - MQTT - create device with thermostat features', () => {
  ...
  it('decode STATUS8 message', () => {
      ...
      features: [
        {
          ...
          external_id: 'tasmota:tasmota-device-topic:TempTargetSet',
          selector: 'tasmota-tasmota-device-topic-temptargetset',
          name: 'Thermostat',
          read_only: false,
          has_feedback: true,
          min: 0,
    ...
    assert.calledWith(gladys.event.emit, EVENTS.DEVICE.NEW_STATE, {
      device_feature_external_id: 'tasmota:tasmota-device-topic:TempTargetSet',
      state: 19.2,
    });
