...
const messages = require('../../../device-creation/THR320.json');
...
describe('Tasmota - MQTT - create device with THR320 temperature feature', () => {
  ...
  it('decode STATUS8 message', () => {
      ...
      features: [
        {
          ...
          external_id: 'tasmota:tasmota-device-topic:SI7021:Temperature',
          selector: 'tasmota-tasmota-device-topic-si7021-temperature',
          name: 'Temperature',
          read_only: true,
          has_feedback: false,
          min: -100,
        ...
        },
        {
          ...
          external_id: 'tasmota:tasmota-device-topic:SI7021:Humidity',
          selector: 'tasmota-tasmota-device-topic-si7021-humidity',
          name: 'Humidity',
          read_only: true,
          has_feedback: false,
          min: 0,
    ...
    assert.calledWith(gladys.event.emit, EVENTS.DEVICE.NEW_STATE, {
      device_feature_external_id: 'tasmota:tasmota-device-topic:SI7021:Temperature',
      state: 17.5,
    });
    assert.calledWith(gladys.event.emit, EVENTS.DEVICE.NEW_STATE, {
      device_feature_external_id: 'tasmota:tasmota-device-topic:SI7021:Humidity',
      state: 55.8,
    });
    assert.calledWith(gladys.event.emit, EVENTS.DEVICE.NEW_STATE, {
