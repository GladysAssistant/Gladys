...
describe('Tasmota - MQTT - getDiscoveredDevices', () => {
  ...
  it('does not duplicate existing energy consumption features', () => {
    const existingWithConsumption = {
      ...
      features: [
        ...
        },
        {
          ...
          selector: 'tasmota:device-1:ENERGY:Total_consumption',
        ...
        },
        {
          ...
          selector: 'tasmota:device-1:ENERGY:Total_cost',
    ...
    expect(consumptionFeatures[0].external_id).to.eq('tasmota:device-1:ENERGY:Total_consumption');
    expect(costFeatures[0].external_id).to.eq('tasmota:device-1:ENERGY:Total_cost');
  });
