...
describe.only('Mqtt handle message', () => {
  ...
  it('should change user position', () => {
    owntracksHandler.handleMqttMessage('owntracks/gladys/john', JSON.stringify( {_type:'location', acc:104, alt:233, batt:97, conn:'w', lat:42.69, lon:42.666, tid:'1', tst:1599250110, vac:2, vel:0} ));
