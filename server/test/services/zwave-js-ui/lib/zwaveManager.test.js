...
describe('zwaveJSUIManager commands', () => {
  ...
  it('should updateConfiguration', () => {
    ...
    setValueStub.calledOnceWith(CONFIGURATION.ZWAVEJSUI_MQTT_URL, DEFAULT.ZWAVEJSUI_MQTT_URL_VALUE, ZWAVEJSUI_SERVICE_ID);

    setValueStub.calledOnceWith(CONFIGURATION.ZWAVEJSUI_MQTT_USERNAME, DEFAULT.ZWAVEJSUI_MQTT_USERNAME_VALUE, ZWAVEJSUI_SERVICE_ID);
