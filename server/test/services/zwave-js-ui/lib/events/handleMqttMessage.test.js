...
describe('zwave node event', () => {
  ...
  it('should send node_alive event', () => {
    ...
    zwaveJSUIManager.handleMqttMessage(
      `${DEFAULT.ROOT}/_EVENTS/${DEFAULT.ZWAVEJSUI_CLIENT_ID}/node/node_alive`,
      JSON.stringify(message),
    );
  ...
  it('should send node_ready event', () => {
    ...
    zwaveJSUIManager.handleMqttMessage(
      `${DEFAULT.ROOT}/_EVENTS/${DEFAULT.ZWAVEJSUI_CLIENT_ID}/node/node_ready`,
      JSON.stringify(message),
    );
  ...
  it('should send node_sleep event', () => {
    ...
    zwaveJSUIManager.handleMqttMessage(
      `${DEFAULT.ROOT}/_EVENTS/${DEFAULT.ZWAVEJSUI_CLIENT_ID}/node/node_sleep`,
      JSON.stringify(message),
    );
  ...
  it('should send node_dead event', () => {
    ...
    zwaveJSUIManager.handleMqttMessage(
      `${DEFAULT.ROOT}/_EVENTS/${DEFAULT.ZWAVEJSUI_CLIENT_ID}/node/node_dead`,
      JSON.stringify(message),
    );
    expect(node.ready).to.be.undefined;
  ...
  it('should send node_wakeup event', () => {
    ...
    zwaveJSUIManager.handleMqttMessage(
      `${DEFAULT.ROOT}/_EVENTS/${DEFAULT.ZWAVEJSUI_CLIENT_ID}/node/node_wakeup`,
      JSON.stringify(message),
    );
    expect(node.ready).to.be.undefined;
  ...
  it('should send node_value_added event', () => {
    ...
    zwaveJSUIManager.handleMqttMessage(
      `${DEFAULT.ROOT}/_EVENTS/${DEFAULT.ZWAVEJSUI_CLIENT_ID}/node/node_value_added`,
      JSON.stringify(message),
    );
  ...
  it('should send statistics_updated event', () => {
    ...
    zwaveJSUIManager.handleMqttMessage(
      `${DEFAULT.ROOT}/_EVENTS/${DEFAULT.ZWAVEJSUI_CLIENT_ID}/node/statistics_updated`,
      JSON.stringify(message),
    );
    expect(node).to.deep.equal({
      id: 1,
