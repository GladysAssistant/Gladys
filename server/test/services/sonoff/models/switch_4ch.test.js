...
describe('SonoffService - Model - 4CH', () => {
  it('get model for Sonoff 4CH', () => {
    const model = models[modelId].getModel();

    expect(model).to.eq('sonoff-4ch');
  });

  it('get label for Sonoff 4CH', () => {
    const label = models[modelId].getLabel();

    expect(label).to.eq('Sonoff 4CH');
  });

  it('get features for Sonoff 4CH', () => {
  ...
  it('fill features for Sonoff 4CH', () => {
