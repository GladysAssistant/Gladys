...
describe('zigbee2mqtt getConfiguration', () => {
  ...
  it('should load stored z2m configuration', async () => {
    ...
    assert.calledWithExactly(gladys.variable.getValue, 'Z2M_MQTT_CONTAINER_NAME', serviceId);
    assert.calledWithExactly(gladys.variable.getValue, 'Z2M_CONTAINER_NAME', serviceId);
    ...
    expect(result).to.deep.equal({
      ...
      mqttContainerName: 'fake',
      z2mContainerName: 'fake',
      timezone: 'fake',
    });
  });
});
