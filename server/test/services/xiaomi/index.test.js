    ...
    features: [
      {
        ...
        external_id: 'xiaomibattery:1234:decimal:battery',
        has_feedback: false,
        keep_history: true,
        max: 100,
        min: 0,
        name: 'xiaomi-1234-battery',
        read_only: true,
        type: 'decimal',
        unit: '%',
      },
      {
        category: 'temperature-sensor',
        external_id: 'xiaomitemperature:1234:decimal:temperature',
        has_feedback: false,
        keep_history: true,
        max: 100,
        min: -20,
        name: 'xiaomi-1234-temperature',
        read_only: true,
        type: 'decimal',
        unit: 'celsius',
      },
      {
        category: 'humidity-sensor',
        external_id: 'xiaomihumidity:1234:decimal',
        has_feedback: false,
        keep_history: true,
        max: 100,
        min: 0,
        name: 'xiaomi-1234-humidity',
        read_only: true,
        type: 'decimal',
        unit: '%',
      },
    ],
    name: 'xiaomi-1234-sensor-temp-hum-pression',
    service_id: 'de051f90-f34a-4fd5-be2e-e502339ec9bd',
    should_poll: false,
  },
  12345: {
    external_id: 'xiaomi:12345',
    features: [
      {
        category: 'battery-sensor',
        external_id: 'xiaomibattery:12345:decimal:battery',
        has_feedback: false,
        keep_history: true,
        max: 100,
        min: 0,
        name: 'xiaomi-12345-battery',
        read_only: true,
        type: 'decimal',
        unit: '%',
      },
      {
        ...
        external_id: 'xiaomimotion:12345:binary:motion',
        has_feedback: false,
        keep_history: true,
        max: true,
        min: false,
        name: 'xiaomi-12345-detect',
        read_only: true,
        type: 'binary',
      },
    ],
    name: 'xiaomi-12345-sensor-motion',
    service_id: 'de051f90-f34a-4fd5-be2e-e502339ec9bd',
    should_poll: false,
  },
  12346: {
    ...
    features: [
      {
        category: 'battery-sensor',
        external_id: 'xiaomibattery:12346:decimal:battery',
        has_feedback: false,
        keep_history: true,
        max: 100,
        min: 0,
        name: 'xiaomi-12346-battery',
        read_only: true,
        type: 'decimal',
        unit: '%',
      },
...
describe('GET /api/v1/service/xiaomi/sensor/temperature', () => {
  it('should get all temperature sensors', async () => {
    ...
    const xiaomiController = XiaomiController(xiaomiManager);
    await xiaomiController['get /api/v1/service/xiaomi/sensor'].controller(req, res);
    assert.calledWith(res.json, temperatureResultSensor);
  });
});
...
describe('GET /api/v1/service/xiaomi/sensor/motion', () => {
  it('should get all motion sensors', async () => {
    ...
    assert.calledWith(res.json, motionSensors);
  });
});
