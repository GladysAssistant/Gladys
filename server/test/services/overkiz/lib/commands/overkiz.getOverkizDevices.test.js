...
const DEVICE_AUTO = {
  '50d30409-4949-4123-a674-aaacc0d28cc4': {
  ...
  'fbb6f179-92b4-479b-9c53-41607e3c7a15': {
  ...
  '45eca6ef-5a88-4859-a84c-f9614258f966': {
    creationTime: 1601921868000,
    lastUpdateTime: 1601921868000,
    label: 'IO (11410052#2)',
  ...
  '2263edf8-95b5-41e9-8c59-a44c89aabe6f': {
    creationTime: 1601921868000,
    lastUpdateTime: 1601921868000,
    label: 'IO (11410052#4)',
  ...
  '3d8317f1-5cfa-475e-9766-582909112fe0': {
    creationTime: 1601921868000,
    lastUpdateTime: 1601921868000,
    label: 'IO (11410052#5)',
  ...
  'c40edcea-4d8c-4224-af1c-696abd4e94ff': {
...
const DEVICE_BASIC = {
  '50d30409-4949-4122-a674-aaacc0d28cc4': {
    ...
    lastUpdateTime: 1586773014000,
    label: 'Box',
    deviceURL: 'internal://0814-0292-7832/pod/0',
    shortcut: false,
    controllableName: 'internal:PodMiniComponent',
    definition: {
      commands: [
  ...
  'fbb6f179-92b4-479a-9c53-41607e3c7a15': {
    ...
    lastUpdateTime: 1601921868000,
    label: 'Radiateur',
    deviceURL: 'io://0814-0292-7832/11410052#1',
    shortcut: false,
    controllableName: 'io:AtlanticElectricalHeaterWithAdjustableTemperatureSetpointIOComponent',
    definition: {
      commands: [
  ...
  '45eca6ef-5a88-4858-a84c-f9614258f966': {
    ...
    lastUpdateTime: 1601921868000,
    label: 'IO (11410052#2)',
    deviceURL: 'io://0814-0292-7832/11410052#2',
    shortcut: false,
    controllableName: 'io:TemperatureInCelciusIOSystemDeviceSensor',
    definition: {
      commands: [],
  ...
  '2263edf8-95b5-41e8-8c59-a44c89aabe6f': {
    ...
    lastUpdateTime: 1601921868000,
    label: 'IO (11410052#4)',
    deviceURL: 'io://0814-0292-7832/11410052#4',
    shortcut: false,
    controllableName: 'io:OccupancyIOSystemDeviceSensor',
    definition: {
      commands: [],
  ...
  '3d8317f1-5cfa-475d-9766-582909112fe0': {
    ...
    lastUpdateTime: 1601921868000,
    label: 'IO (11410052#5)',
    deviceURL: 'io://0814-0292-7832/11410052#5',
    shortcut: false,
    controllableName: 'io:CumulatedElectricalEnergyConsumptionIOSystemDeviceSensor',
    definition: {
      commands: [],
  ...
  'c40edcea-4d8c-4223-af1c-696abd4e94ff': {
    ...
    lastUpdateTime: 1601391514000,
    label: 'IO (15909334)',
    deviceURL: 'io://0814-0292-7832/15909334',
    shortcut: false,
    controllableName: 'io:StackComponent',
    definition: {
      commands: [
...
describe('getOverkizDevices', () => {
    ...
    expect(devices).to.deep.equal([
      {
        ...
        params: [
          {
            name: 'ID',
            value: 'fbb6f179-92b4-479a-9c53-41607e3c7a15',
          },
          {
            name: 'URL',
            value: 'io://0814-0291-7832/11410052#1',
          },
          {
            name: 'ONLINE',
            value: 'available',
  ...
  it('should return device BASIC', async () => {
    overkizHandler.devices = DEVICE_BASIC;
    overkizHandler.connected = true;
    const devices = await overkizHandler.getOverkizDevices();
    expect(devices).to.deep.equal([
      {
        external_id: 'overkiz:deviceURL:io://0814-0292-7832/11410052#1',
        name: 'Radiateur (Salle de bain)',
        model: 'AGILIA H PI-io 750W (Atlantic)',
        service_id: 'OVERKIZ_SERVICE_ID',
        should_poll: true,
        ...
        features: [
          {
            category: 'thermostat',
            external_id: 'overkiz:deviceURL:io://0814-0292-7832/11410052#1:state:core:TargetTemperatureState',
            has_feedback: true,
            max: 40,
            min: 0,
            name: 'Temperature',
            read_only: false,
            selector: 'overkiz-deviceurl-io-0814-0292-7832-114100521-state-core-targettemperaturestate',
            type: 'target-temperature',
            unit: 'celsius',
          },
          {
            category: 'temperature-sensor',
            external_id: 'overkiz:deviceURL:io://0814-0292-7832/11410052#2:state:core:TemperatureState',
            has_feedback: true,
            max: 40,
            min: 0,
            name: 'Temperature',
            read_only: true,
            selector: 'overkiz-deviceurl-io-0814-0292-7832-114100522-state-core-temperaturestate',
            type: 'decimal',
            unit: 'celsius',
          },
          {
            name: 'Occupancy',
            selector: 'overkiz-deviceurl-io-0814-0292-7832-114100524-state-core-occupancystate',
            category: 'presence-sensor',
            type: 'push',
            external_id: 'overkiz:deviceURL:io://0814-0292-7832/11410052#4:state:core:OccupancyState',
            read_only: true,
            has_feedback: false,
            keep_history: true,
            min: 0,
        ...
        params: [
          ...
          {
            name: 'URL',
            value: 'io://0814-0292-7832/11410052#1',
          },
          {
            name: 'ONLINE',
            value: 'available',
  ...
  it('should return device AUTO', async () => {
    overkizHandler.devices = DEVICE_AUTO;
    overkizHandler.connected = true;
    const devices = await overkizHandler.getOverkizDevices();
    expect(devices).to.deep.equal([
      {
        ...
        params: [
          {
            name: 'ID',
            value: 'fbb6f179-92b4-479b-9c53-41607e3c7a15',
          },
          {
            name: 'URL',
            value: 'io://0814-0291-7832/11410052#1',
  ...
  it('should return 2 devices', async () => {
    overkizHandler.devices = Object.assign(DEVICE_BASIC, DEVICE_AUTO);
    overkizHandler.connected = true;
    const devices = await overkizHandler.getOverkizDevices();
