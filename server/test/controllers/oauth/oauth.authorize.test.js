...
const { oauthAuthenticatedRequest, authenticatedRequest } = require('../request.test');
...
describe('GET /oauth/authorize', () => {
  it('should call authorize', async () => {
    ...
    await oauthAuthenticatedRequest
      .get(
  ...
  it('should call authorize, but fail as not an oatuh token', async () => {
    const clientId = 'oauth_client_1';
    const redirectUri = 'http://oauth1.fr';
    const state = 'state_code';
