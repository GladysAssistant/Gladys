...
const { intToHex, hexToInt, intToRgb, rgbToInt } = require('../../utils/colors');
...
describe('colors', () => {
  const matchingTable = {
    ...
    red: { int: 16711680, hex: 'FF0000', rgb: [255, 0, 0] },
    lime: { int: 65280, hex: '00FF00', rgb: [0, 255, 0] },
    ...
    white: { int: 16777215, hex: 'FFFFFF', rgb: [255, 255, 255] },
    gray: { int: 12632256, hex: 'C0C0C0', rgb: [192, 192, 192] },
    black: { int: 0, hex: '000000', rgb: [0, 0, 0] },
  };

  Object.keys(matchingTable).forEach((color) => {
    const { int, hex, rgb } = matchingTable[color];
