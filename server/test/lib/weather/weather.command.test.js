...
describe('weather.command', () => {
    ...
    it('should get the weather', async () => {
        ...
        assert.calledWith(
            messageManager.replyByIntent,
            message,
            'weather.get.success.cloud',
            { temperature: 54.87, units: '°C' }
        );
    });
    it('should get the weather for tomorrow', async () => {
        ...
        assert.calledWith(
            messageManager.replyByIntent,
            message,
            'weather.tomorrow.success.rain',
            { temperature_max: 11, temperature_min: 6, units: '°C' }
        );
    });
    it('should get the weather for after tomorrow', async () => {
        ...
        assert.calledWith(
            messageManager.replyByIntent,
            message,
            'weather.after-tomorrow.success.clear',
            { temperature_max: 9, temperature_min: 4, units: '°C' }
        );
    });
    ...
    it('should get the weather for next sunday', async () => {
        ...
        assert.calledWith(
            messageManager.replyByIntent,
            message,
            'weather.day.success.cloud',
            { day: 'sunday', temperature_max: 9, temperature_min: 5, units: '°C' }
        );
    });
