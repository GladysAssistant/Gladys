 ...
 * as the 30-min scheduled poll — the data re-enters through the audited
 * pull path, the nudge itself carries nothing. Fire-and-forget: a nudge
 * from a non-weather integration or beyond the rate limit is silently
 * dropped (no error path, the 30-min floor catches up).
