...
const { getDeviceFeatureStatesPaginated } = require('./device.getDeviceFeatureStatesPaginated');
...
const { destroyState } = require('./device.destroyState');
const { updateState } = require('./device.updateState');
const { refreshFeatureLastValue } = require('./device.refreshFeatureLastValue');
...
DeviceManager.prototype.getDeviceFeatureStatesPaginated = getDeviceFeatureStatesPaginated;
...
DeviceManager.prototype.destroyState = destroyState;
DeviceManager.prototype.updateState = updateState;
DeviceManager.prototype.refreshFeatureLastValue = refreshFeatureLastValue;
