...
/**
 * @description Get new  AccesToken with client_id and secrei_id of current oauth2 integration.
 ...
 * );
 */
async function getAccesToken(serviceId, userId, authorizationCode, referer) {
  ...
  const additionalAccesTokenRequestAxtionParam = await this.variable.getValue(
