...
const DEVICE_FEATURE_UNITS_BY_CATEGORY = {
  ...
  [DEVICE_FEATURE_CATEGORIES.DISTANCE_SENSOR]: [DEVICE_FEATURE_UNITS.MILLIMETER, DEVICE_FEATURE_UNITS.CENTIMETER],
  [DEVICE_FEATURE_CATEGORIES.HUMIDITY_SENSOR]: [DEVICE_FEATURE_UNITS.PERCENT],
  [DEVICE_FEATURE_CATEGORIES.LIGHT_SENSOR]: [DEVICE_FEATURE_UNITS.LUX],
  [DEVICE_FEATURE_CATEGORIES.PRESSURE_SENSOR]: [DEVICE_FEATURE_UNITS.PASCAL, DEVICE_FEATURE_UNITS.MILLIBAR],
...
module.exports.DEVICE_FEATURE_UNITS_BY_CATEGORY_TYPES = DEVICE_FEATURE_UNITS_BY_CATEGORY_TYPES;
module.exports.DEVICE_FEATURE_TYPES_BY_CATEGORY = DEVICE_FEATURE_TYPES_BY_CATEGORY;
