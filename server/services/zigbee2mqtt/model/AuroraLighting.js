...
const AuroraLighting = {
  ...
  models: {
    ...
    'AU-A1ZBDSS': [features.power, features.switch_sensor],
    'AU-A1ZBDWS': [features.door],
    'AU-A1ZBPIA': [features.current, features.energy, features.power, features.switch_sensor, features.voltage],
    'AU-A1ZBPIAB': [features.current, features.power, features.switch_sensor, features.voltage],
