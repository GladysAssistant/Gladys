...
const Legrand = {
  ...
  models: {
    ...
    '067775/741811': [features.button, features.current, features.power, features.switch_sensor, features.voltage],
    '067776': [features.door],
    '412015': [features.power],
    '752189': [features.button],
    FC80CC: [features.power, features.switch_sensor],
    FC80RC: [features.power, features.switch_sensor],
