...
const Develco = {
  ...
  models: {
    ...
    'SMRZB-143': [features.current, features.energy, features.power, features.switch_sensor, features.voltage],
    'SMRZB-332': [features.energy, features.power, features.switch_sensor],
    'SMSZB-120': [features.smoke, features.temperature],
    'SPLZB-131': [features.current, features.energy, features.power, features.switch_sensor, features.voltage],
    'SPLZB-132': [features.current, features.energy, features.power, features.switch_sensor, features.voltage],
    'SPLZB-134': [features.current, features.energy, features.power, features.switch_sensor, features.voltage],
