...
async function installZ2mContainer(config) {
  ...
  if (dockerContainers.length > 0 && container.devices[0].PathOnHost !== z2mDriverPath) {
    logger.info('Zigbee2mqtt container should be removed (new USB dongle path configured)...');
