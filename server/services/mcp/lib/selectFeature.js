...
const historyFeatures = [
  ...
  `${DEVICE_FEATURE_CATEGORIES.ENERGY_SENSOR}:${DEVICE_FEATURE_TYPES.ENERGY_SENSOR.DAILY_CONSUMPTION_COST}`,
  `${DEVICE_FEATURE_CATEGORIES.ENERGY_SENSOR}:${DEVICE_FEATURE_TYPES.ENERGY_SENSOR.THIRTY_MINUTES_CONSUMPTION}`,
  `${DEVICE_FEATURE_CATEGORIES.ENERGY_SENSOR}:${DEVICE_FEATURE_TYPES.ENERGY_SENSOR.THIRTY_MINUTES_CONSUMPTION_COST}`,
  `${DEVICE_FEATURE_CATEGORIES.SWITCH}:${DEVICE_FEATURE_TYPES.SWITCH.POWER}`,
  `${DEVICE_FEATURE_CATEGORIES.SWITCH}:${DEVICE_FEATURE_TYPES.SWITCH.ENERGY}`,
];
