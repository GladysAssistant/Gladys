...
const DEVICE_PARAM_CAMERA_URL = 'CAMERA_LIVE_URL';
...
async function startStreaming(cameraSelector, isGladysGateway, segmentDuration = 1) {
  ...
  try {
    ...
    const encryptionKeyUrl = `BACKEND_URL_TO_REPLACE/api/v1/service/netatmo/camera/streaming/${cameraFolder}/index.m3u8.key`;
