...
const { updateNAModule1 } = require('./device/netatmo.updateNAModule1');
const { updateNAModule2 } = require('./device/netatmo.updateNAModule2');
const { updateNAModule3 } = require('./device/netatmo.updateNAModule3');
