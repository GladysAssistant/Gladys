...
const INDEXES = {
  ...
  INDEX_SWITCH_METER_ENERGY: 0,
  INDEX_SWITCH_METER_POWER: 2,
  INDEX_SWITCH_METER_VOLTAGE: 4,
  INDEX_SWITCH_METER_CURRENT: 5,
...
const CATEGORIES = [
  ...
  // Roller shutter Fibaro FGRM222 Roller Shutter Controller 2
  {
    ...
    PRODUCT_IDS: ['0x1000'],
    PRODUCT_TYPES: ['0x0302'],
  },
  // Roller shutter ZMNHCDx Flush Shutter
  {
    CATEGORY: DEVICE_FEATURE_CATEGORIES.SWITCH,
    TYPE: DEVICE_FEATURE_TYPES.SWITCH.DIMMER,
    COMMAND_CLASSES: [COMMAND_CLASSES.COMMAND_CLASS_SWITCH_MULTILEVEL],
  ...
  {
    CATEGORY: DEVICE_FEATURE_CATEGORIES.SWITCH,
    COMMAND_CLASSES: [COMMAND_CLASSES.COMMAND_CLASS_SWITCH_BINARY, COMMAND_CLASSES.COMMAND_CLASS_CENTRAL_SCENE],
  ...
  // switch power meter
  {
    CATEGORY: DEVICE_FEATURE_CATEGORIES.SWITCH,
    COMMAND_CLASSES: [COMMAND_CLASSES.COMMAND_CLASS_METER],
    PROPERTIES: [PROPERTIES.ELECTRIC_CONSUMED_KWH],
  ...
  // switch current
  {
    CATEGORY: DEVICE_FEATURE_CATEGORIES.SWITCH,
    COMMAND_CLASSES: [COMMAND_CLASSES.COMMAND_CLASS_METER],
    INDEXES: [INDEXES.INDEX_SWITCH_METER_CURRENT],
...
const GENRE = {
  'COMMAND_CLASSES.COMMAND_CLASS_CONFIGURATION': 'config',
  'COMMAND_CLASSES.COMMAND_CLASS_MANUFACTURER_SPECIFIC': 'system',
  'COMMAND_CLASSES.COMMAND_CLASS_POWERLEVEL': 'system',
  'COMMAND_CLASSES.COMMAND_CLASS_WAKE_UP': 'system',
  'COMMAND_CLASSES.COMMAND_CLASS_VERSION': 'system',
  'COMMAND_CLASSES.COMMAND_CLASS_ZWAVEPLUS_INFO': 'system',
};
