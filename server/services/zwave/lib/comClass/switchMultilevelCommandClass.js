...
SwitchMultilevelCommandClass.prototype = {
   ...
   */
  getTransformedValue: function getTransformedValue(node, comClass, index, instance, value) {
    return DefaultCommandClass.getTransformedValue(node, comClass, index, instance, value);
  },
  /**
   ...
   */
  getNormalizedValue: function getNormalizedValue(node, comClass, index, instance, value) {
   ...
   */
  getMinMax: function getMinMax(node, comClass, index, instance) {
...
module.exports = new SwitchMultilevelCommandClass();
