...
const CATEGORIES = [
  ...
  // motion sensor
  {
    ...
    PROPERTIES: [PROPERTIES.MOTION, PROPERTIES.MOTION_ANY],
...
const CONFIGURATION = {
  EXTERNAL_ZWAVE2MQTT: 'EXTERNAL_ZWAVE2MQTT',
  ZWAVE2MQTT_MQTT_URL_KEY: 'ZWAVE2MQTT_MQTT_URL',
  ZWAVE2MQTT_MQTT_USERNAME_KEY: 'ZWAVE2MQTT_MQTT_USERNAME',
  ZWAVE2MQTT_MQTT_PASSWORD_KEY: 'ZWAVE2MQTT_MQTT_PASSWORD',
  ZWAVE2MQTT_MQTT_PASSWORD_VALUE: 'xcpKsyVzOVtSCgUEAQsh',
  ZWAVE_DRIVER_PATH: 'ZWAVE_DRIVER_PATH',
...
const DEFAULT = {
  EXTERNAL_ZWAVE2MQTT: true,
  ROOT: 'zwave2mqtt',
  ZWAVE2MQTT_MQTT_URL_VALUE: 'mqtt://localhost:1883',
  ZWAVE2MQTT_MQTT_USERNAME_VALUE: 'gladys',
  MQTT_CLIENT_ID: 'gladys-main-instance',
  ZWAVE2MQTT_CLIENT_ID: 'Domotix',
  TOPICS: [
    'zwave2mqtt/#', // Default zwave2mqtt topic
  ],
};
