...
const getTpLinkPlug = (device, deviceSysInfo, serviceId) => ({
  ...
  features: [
    {
      ...
      read_only: false,
      has_feedback: false,
      external_id: `${TP_LINK_EXTERNAL_ID_BASE}:${deviceSysInfo.deviceId}:${DEVICE_FEATURE_TYPES.SWITCH.BINARY}`,
      selector: `${TP_LINK_EXTERNAL_ID_BASE}:${deviceSysInfo.deviceId}:${DEVICE_FEATURE_TYPES.SWITCH.BINARY}`,
