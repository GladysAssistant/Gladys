...
/**
 * @description Transforms Tessie feature as Gladys feature. Temperature setpoint.
 ...
 * @example
 * buildFeatureThermSetpointTemperature(device_name, 'tessie:device_id');
 */
...
/**
 * @description Transforms Tessie feature as Gladys feature. Heating boiler status.
 * @param {string} name - Name device from Tessie.
 * @param {string} externalId - Gladys external ID.
 * @returns {object} Gladys feature or undefined.
 * @example
 * buildFeatureHeatingBoilerStatus(device_name, 'tessie:device_id');
 */
...
/**
 * @description Transforms Tessie feature as Gladys feature. Heating power request.
 * @param {string} name - Name device from Tessie.
 * @param {string} externalId - Gladys external ID.
 * @returns {object} Gladys feature or undefined.
 * @example
 * buildFeatureHeatingPowerRequest(device_name, 'tessie:device_id');
 */
...
/**
 * @description Transforms Tessie feature as Gladys feature. Plug connected boiler.
 * @param {string} name - Name device from Tessie.
 * @param {string} externalId - Gladys external ID.
 * @returns {object} Gladys feature or undefined.
 * @example
 * buildFeaturePlugConnectedBoiler(device_name, 'tessie:device_id');
 */
 ...
 * @returns {object} Gladys feature or undefined.
 * @example
 * buildFeatureOpenWindow(device_name, 'tessie:device_id');
 */
