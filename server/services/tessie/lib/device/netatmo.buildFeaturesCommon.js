 ...
 * @example
 * buildFeatureBattery(device_name, 'tessie:device_id');
 */
 ...
 * @returns {object} Gladys feature or undefined.
 * @example
 * buildFeatureRfStrength(device_name, 'tessie:device_id');
 */
 ...
 * @returns {object} Gladys feature or undefined.
 * @example
 * buildFeatureWifiStrength(device_name, 'tessie:device_id');
 */
