...
/**
 * @description Transforms Tessie feature as Gladys feature. CO2.
 * @param {string} name - Name device from Tessie.
 * @param {string} externalId - Gladys external ID.
 * @returns {object} Gladys feature or undefined.
 * @example
 * buildFeatureCo2(device_name, 'tessie:device_id');
 */
...
/**
 * @description Transforms Tessie feature as Gladys feature. Humidity.
 * @param {string} name - Name device from Tessie.
 * @param {string} externalId - Gladys external ID.
 * @returns {object} Gladys feature or undefined.
 * @example
 * buildFeatureHumidity(device_name, 'tessie:device_id');
 */
...
/**
 * @description Transforms Tessie feature as Gladys feature. Noise decibel.
 * @param {string} name - Name device from Tessie.
 * @param {string} externalId - Gladys external ID.
 * @returns {object} Gladys feature or undefined.
 * @example
 * buildFeatureNoise(device_name, 'tessie:device_id');
 */
...
/**
 * @description Transforms Tessie feature as Gladys feature. Current Pressure or Absolute pressure.
 * @param {string} name - Name device from Tessie.
 * @param {string} externalId - Gladys external ID.
 * @param {string} featureName - Gladys external ID.
 * @returns {object} Gladys feature or undefined.
 * @example
 * buildFeaturePressure(device_name, 'tessie:device_id', 'pressure');
 */
...
/**
 * @description Transforms Tessie feature as Gladys feature. Speed of wind.
 * @param {string} name - Name device from Tessie.
 * @param {string} externalId - Gladys external ID.
 * @param {string} featureName - Gladys external ID.
 * @returns {object} Gladys feature or undefined.
 * @example
 * buildFeatureWindStrength(device_name, 'tessie:device_id', 'wind_strength');
 */
...
/**
 * @description Transforms Tessie feature as Gladys feature. Angle of wind.
 * @param {string} name - Name device from Tessie.
 * @param {string} externalId - Gladys external ID.
 * @param {string} featureName - Gladys external ID.
 * @returns {object} Gladys feature or undefined.
 * @example
 * buildFeatureWindAngle(device_name, 'tessie:device_id', 'wind_angle');
 */
...
/**
 * @description Transforms Tessie feature as Gladys feature.Precipitation per hour and sum of the day.
 * @param { string } name - Name device from Tessie.
 * @param { string } externalId - Gladys external ID.
 ...
 * @returns { object } Gladys feature or undefined.
 * @example
 * buildFeatureRain(device_name, 'tessie:device_id', 'rain', 'mm');
 */
