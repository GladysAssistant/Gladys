  ...
  return [
    {
      ...
      selector: `tessie-${externalId}-charge-current`,
    ...
    },
    {
      ...
      selector: `tessie-${externalId}-charge-energy-added-total`,
      category: DEVICE_FEATURE_CATEGORIES[category],
    ...
    },
    {
      ...
      selector: `tessie-${externalId}-charge-energy-consumption-total`,
      category: DEVICE_FEATURE_CATEGORIES[category],
    ...
    },
    {
      ...
      selector: `tessie-${externalId}-charge-on`,
      category: DEVICE_FEATURE_CATEGORIES[category],
    ...
    },
    {
      ...
      selector: `tessie-${externalId}-charge-power`,
      category: DEVICE_FEATURE_CATEGORIES[category],
    ...
    },
    {
      ...
      selector: `tessie-${externalId}-charge-voltage`,
      category: DEVICE_FEATURE_CATEGORIES[category],
    ...
    },
    {
      ...
      selector: `tessie-${externalId}-last-charge-energy-added`,
      category: DEVICE_FEATURE_CATEGORIES[category],
    ...
    },
    {
      ...
      selector: `tessie-${externalId}-last-charge-energy-consumption`,
      category: DEVICE_FEATURE_CATEGORIES[category],
    ...
    },
    {
      ...
      selector: `tessie-${externalId}-plugged`,
      category: DEVICE_FEATURE_CATEGORIES[category],
    ...
    },
    {
      ...
      selector: `tessie-${externalId}-target-charge-limit`,
      category: DEVICE_FEATURE_CATEGORIES[category],
    ...
    },
    {
      ...
      selector: `tessie-${externalId}-target-current`,
      category: DEVICE_FEATURE_CATEGORIES[category],
