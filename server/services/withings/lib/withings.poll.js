...
async function poll(device) {
  ...
  if (device.features) {
    ...
    const accessToken = device.params.find((oneParam) => oneParam.name === 'accessToken').value;
    const refreshToken = device.params.find((oneParam) => oneParam.name === 'refreshToken').value;
    const tokenType = device.params.find((oneParam) => oneParam.name === 'tokenType').value;
